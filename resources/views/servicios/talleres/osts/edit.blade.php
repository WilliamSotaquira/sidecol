...
<section class="content">
  ...
  {!!Form::model($data,['method'=>'PUT','route'=>['servicios.talleres.osts.update',$data->idost],'files'=>'true'])!!}
  {{Form::token()}}
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="col-xs-12 col-sm-4 col-lg-2 text-center" style="padding-bottom: 5px; padding-top: 5px">
        ...
        <a href="{{route('servicios.talleres.osts.index')}}" class="btn btn-info btn_end" id="back" >Atras</a><br>

      </div>
      <div class="col-xs-12 col-sm-4 col-lg-2 text-center" style="padding-bottom: 5px; padding-top: 5px">


        <a href="{{route('servicios.talleres.osts.edit',['idost' => Crypt::encrypt($data->idost)])}}" class="btn btn-default btn_end" id="back" >Limpiar</a><br>
