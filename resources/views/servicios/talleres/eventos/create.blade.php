...
@section ('contenido')
@include('servicios.talleres.eventos.encabezado')



<section class="content">

  {!!Form::open(array('url'=>'servicios/talleres/eventos/store','method'=>'POST','autocomplete'=>'off', 'files'=> true))!!}
  {{ csrf_field() }}
              ...
              <div class="col-xs-12 col-sm-12">
                <div class="form-group ">
                  ...
                  <div class="col-sm-12">
                    <select id="idost" name="idost" class="selectpicker form-control" data-live-search="true" required="required" >
                      @foreach($osts as $ost)  
                      <option value="{{$ost->idost}}" selected ="selected">OST{{$ost->idost}} | {{$ost->contacto}}</option>  
                      @endforeach
                    </select>                                              
                  </div>          
                </div>
