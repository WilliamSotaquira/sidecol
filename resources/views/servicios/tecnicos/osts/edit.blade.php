...
<section class="content">
  ...
  {!!Form::model($data,['method'=>'PUT','route'=>['servicios.tecnicos.osts.update',$data->idost],'files'=>'true'])!!}
  {{Form::token()}}


  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Taller - Editar Registro <strong>OST{{$data->idost}}</strong></h3>
    ...
    <div class="container-fluid">
      <div class="box-body">
              ...
              <div class="row row-first">
                ...
                <div class="col-xs-12 col-sm-12">
                 <div class="form-group">
                  ...
                  <div class="col-sm-4  ">
                    <select id="tipo_os" name="tipo_os" class="selectpicker form-control" autofocus="autofocus" data-live-search="true" id="tipo_os" disabled="disabled">
         ...
         <div class="panel panel-info row " >
          ...
          <div class="row row-first">
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
               ...
               <div class="col-xs-12 col-sm-6"> 
                <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="form-group">
                      <label for="contacto_ost" class="col-xs-12 col-sm-4 control-label">Persona Contacto *</label>
                      <div class="col-sm-7">
                       <input type="text" class="form-control" autocomplete="autocomplete" name="contacto_ost" id="contacto_ost" placeholder="Nombre Completo" value="{{$data->contacto_ost}}" disabled="disabled">
                     </div> 
                   </div>
                 </div>
                 ...
                 <div class="row">
                   <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <select name="tipo_doc" class="form-control selectpicker" data-size="6" data-live-search="true" id="tipo_doc" value="{{$data->tipo_doc}}" disabled="disabled">
                ...
                <div class="row">
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                   <input type="text" class="form-control" autocomplete="autocomplete" name="numero_doc" id="numero_doc" value="{{$data->numero_doc}}" disabled="disabled">
                 </div> 
               </div>
             </div>
             ...
             <div class="row">
               <div class="form-group">
                ...
                <div class="col-sm-7">
                 <input type="text" class="form-control" autocomplete="autocomplete" name="direccion_ost" id="direccion_ost" value="{{$data->direccion_ost}}" disabled="disabled">
               </div> 
             </div>
           </div>
           ...
           <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <select name="municipio_id" class="form-control selectpicker" data-size="6" data-live-search="true" id="municipio_id" value="{{old('municipio_id')}}" disabled="disabled">
          ...
          <div class="row">
           <div class="form-group">
            ...
            <div class="col-sm-7">
             <input type="email_ost" class="form-control" autocomplete="autocomplete" name="email_ost" id="email_ost" value="{{$data->email_ost}}">
           </div> 
         </div>
       </div>
       ...
       <div class="row">
         <div class="form-group">
          <label for="celular_ost" class="col-xs-12 col-sm-4 control-label">celular_ost *</label>
          <div class="col-sm-7">
           <input type="number" class="form-control" autocomplete="autocomplete" name="celular_ost" id="celular_ost" value="{{$data->celular_ost}}">
         </div> 
       </div>
     </div>
     ...
     <div class="row">
       <div class="form-group">
        <label for="telefono_ost" class="col-xs-12 col-sm-4 control-label">Telefono</label>
        <div class="col-sm-7">
         <input type="number" class="form-control" autocomplete="autocomplete" name="telefono_ost" id="telefono_ost" value="{{$data->telefono_ost}}" >
       </div> 
     </div>
   </div>
    ...
    <div class="row row-first">
      ...
      <div class="col-xs-12 col-sm-12">
       <div class="form-group">
        ...
        <div class="col-sm-4  ">
          <select id="estado_os" name="estado_os" class="selectpicker form-control" autofocus="autofocus" data-live-search="true" disabled=" disabled=">
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="col-xs-12 col-sm-4 col-lg-2 text-center" style="padding-bottom: 5px; padding-top: 5px">
        ...
        <a href="{{route('servicios.tecnicos.osts.index')}}" class="btn btn-info btn_end" id="back" >Atras</a><br>

      </div>
      <div class="col-xs-12 col-sm-4 col-lg-2 text-center" style="padding-bottom: 5px; padding-top: 5px">


        <a href="{{route('servicios.tecnicos.osts.edit',['idost' => Crypt::encrypt($data->idost)])}}" class="btn btn-default btn_end" id="back" >Limpiar</a><br>
