...
<section class="content"> 
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <h3 class="box-title">Eventos - {{$talleruser->razonsocial}}</h3>
      ...
      <div class="container-fluid">
        ...
        <div class="row mt-1 justify-content-between align-items-center" >
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            ...
            <center><a href="{{route ('servicios.tecnicos.eventos.create',$id)}}" ><button class="btn btn-success">Crear Nuevo Evento</button></a></center>
          ...
          <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
           ...
           @include('servicios.tecnicos.eventos.search') 
            ...
            <tbody>
              ...
              <tr>
                ...
                <td >
                  ...
                  <a href="{{$eventoost->soporte}}" title=""><img src="{{asset ($eventoost->soporte)}}" alt=" Archivo sin imagen" height="100px" width="100px" class="img-thumbnail"></a>
                  @endif
                </td>    
