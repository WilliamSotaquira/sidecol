...
@section ('contenido')
@include('servicios.tecnicos.eventos.encabezado')



<section class="content">

  {!!Form::open(array('url'=>'servicios/tecnicos/eventos/store','method'=>'POST','autocomplete'=>'off', 'files'=> true))!!}
  {{ csrf_field() }}
            ...
            <div class="row row-first" >
              <div class="col-xs-12 col-sm-12">
                <div class="form-group ">
                  ...
                  <div class="col-sm-12">
                    <select id="idost" name="idost" class="selectpicker form-control" data-live-search="true" required >
             ...
             <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                ...
                <form id="file-submit" enctype="multipart/form-data">
                  <input id="soporte" name="soporte" type="file" class="form-control" style="max-width: 15px;" size="1048576" maxlength="50">
                </form>
              </div>
            </div>
          </div>
...
<script>
  ...
  $(function() {
    ...
    // Podemos adjuntar el evento `fileselect` a todos los archivos
    ...
    // Podemos ver nuestro evento personalizado `fileselect` como este
