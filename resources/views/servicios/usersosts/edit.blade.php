...
<section class="content">
  ...
  {!!Form::model($data,['method'=>'PUT','route'=>['servicios.usersosts.update',$data->idusers_ost],'files'=>'true'])!!}
  {{Form::token()}}


  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Editar Asignación {{$data->idusers_ost}}</h3>
    ...
    <div class="col-xs-12 col-sm-6">
     <div class="form-group">
      <label for="estado_uo" class="col-xs-12 col-sm-4" >Estado de la Asignación</label>
      <div class="col-sm-8">
