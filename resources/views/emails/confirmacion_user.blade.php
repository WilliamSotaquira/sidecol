								...
								<tr>
									...
									<td>
										<div align="center" class="m_6309808043716325268mdv2rw" style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:30px 20px;">
											...
											<div style="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.87);font-size:36px" >
												Tu servicio  ha sido asignado
											</div>
											...
											<div style="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-bottom:thin solid #dadce0;color:rgba(0,0,0,0.87);line-height:32px;padding-bottom:24px;padding-bottom:6px;padding-top:10px;text-align:center;word-break:break-word">
												<div style="font-size:24px">
													...
													</div>Estamos aquí para ayudarte...
												</div>
													...
													<tbody>
														<tr>
															<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																<p style="margin-bottom:0;margin-top:0">Se ha completado la asignacion de un técnico especializado para su orden 
																	de servicio. Su informacion:
																</p>
															</td>
														</tr>
													...
													<tbody>
														...
														<tr>
															<td colspan="2" style="padding-bottom:12px;text-align:center;color:#3c4043">
																<p style="margin-bottom:0;margin-top:0">A continuación se describe la informacion del tecnico, del servicio, y sus detalles.
																</p>
															</td>
														</tr>
														...
														<tr>
															<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																<p style="margin-bottom:0;margin-top:0"><strong>¿Desea conocer el estado de su servicio?<br></strong> <a href="{{route('progreso',['idost' => Crypt::encrypt($idservicio)])}}">Orden de servicio</a>
																</p>
															</td>
											...
											<table style="font-size:14px;letter-spacing:0.2;line-height:20px;text-align:center">
												<tbody>
													...
													<tr>
														...
														<td style="color:rgba(0,0,0,0.87);vertical-align:top;padding:16px 0 0 0;text-align:start">
															<div style="font-size:16px;line-height:24px">
																<b>¿Como puedo cancelar la orden de servicio adecuadamente?
																</b>
															</div>
															<div style="margin-top:4px">Para cancelar la orden de servicio puede acceder mediante el siguiente enlace, recuerde que debe realizar este proceso con <strong>24 horas</strong> de anticipación.
																<div>
																	<a href="{{route ('servicios.eventososts.create',['id' => Crypt::encrypt($idservicio)])}}" style="color:rgb(0, 0, 128);">Realizar&nbsp;cancelación&nbsp;OST&nbsp;
																	</a>
																</div>
															</div>
														</td>
