									...
									<td>
										<div align="center" class="m_6309808043716325268mdv2rw" style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:30px 20px;">
											...
											<div style="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serifcolor:rgba(0,0,0,0.87);font-size:26px" >											
												Nueva orden de servicio técnico <br> OST{!!Crypt::decrypt($idservicio)!!}
											</div>
													...
													<tbody>
														<tr>
															<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																<p style="margin-bottom:0;margin-top:0"><strong>Señor técnico, </strong>{!!$razonsocial!!} e Idea Colombia S.A.S desean asignarle nuevo servicio técnico.
																</p>
															</td>
														</tr>
													...
													<tbody>
														...
														<tr>
															<td colspan="2" style="padding-bottom:12px;text-align:center;color:#3c4043">
																<p style="margin-bottom:0;margin-top:0">A continuación se describe la información del servicio, el cliente y sus detalles.
																</p>
															</td>
														</tr>
														...
														<tr>
															...
															<td style="padding-bottom:5px;text-align:start;">
																<p style="margin-bottom:0;margin-top:0">{!!$tipo!!}
																</p>												
															</td>
														</tr>
														...
														<tr>
															...
															<td style="padding-bottom:5px;text-align:start;">
																...
																<p style="margin-bottom:0;margin-top:0">OST{!!Crypt::decrypt($idservicio)!!}
																</p>
														...
														<tr>
															<td width="50%">
																<p style="margin-bottom:0;margin-top:0">Fecha Sugerida:
																</p>												
															</td>
															<td style="padding-bottom:5px;text-align:start;">
														...
														<tr>
															<td width="50%">
																<p style="margin-bottom:0;margin-top:0">Jornada Sugerida:
																</p>												
															</td>
															<td style="padding-bottom:5px;text-align:start;">
														...
														<tr>
															<td width="50%">
																<p style="margin-bottom:0;margin-top:0">Telefono de contacto:
																</p>												
															</td>
															<td style="padding-bottom:5px;text-align:start;">
																<p style="margin-bottom:0;margin-top:0">
														...
														<tr>
															<td width="50%">
																<p style="margin-bottom:0;margin-top:0">Productos:
																</p>												
															</td>
															<td style="padding-bottom:5px;text-align:start;">
																<p style="margin-bottom:0;margin-top:0">
													...
													<div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:center">
														<table style="font-size:14px;letter-spacing:0.2;line-height:20px;text-align:center;padding-bottom:24px;border-bottom:thin solid #f0f0f0 ">
															<tbody>
																<tr>
																	<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																		<p style="margin-bottom:0;margin-top:0"><strong>¿Desea aceptar el servicio ?<br></strong> 

																			<a href="{{route('servicios.eventososts.aceptar',$idservicio)}}" class="btn btn-sm btn-success ">Aceptar orden de servicio técnico y contactar al cliente</a>
																...
																<tr>
																	<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																		<p style="margin-bottom:0;margin-top:0"><strong>¿Desea proponer otra horario para el servicio?<br></strong> <a href="{{route ('servicios.osts.show',$idservicio)}}">Contactar al cliente</a>
																		</p>
																	</td>
																...
																<tr>
																	<td colspan="2" style="padding-bottom:12px;text-align:center;color:rgba(0,0,0,0.87);">
																		<p style="margin-bottom:0;margin-top:0">Si desea rechazar el servicio técnico siga el siguiente enlace: <a href="{{route ('servicios.usersosts.index')}}">Rechazar orden de servicio técnico</a>
																		</p>
																	</td>
																</tr>
