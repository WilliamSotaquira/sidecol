...
<section class="content">
  ...
  {!!Form::open(array('url'=>'productos/bodegas/store','method'=>'POST','autocomplete'=>'off', 'files'=> true))!!}
  {{ csrf_field() }}
      ...
      <div class="box-body">
        <div class="col-xs-12 col-sm-8 ">
          ...
          <div class="row row-first" >
            <div class="col-xs-12 col-sm-12">
              <div class="form-group ">
                <label for="TipoBodega" class="col-xs-12 col-sm-2">Tipo Bodega</label>
                <div class="col-sm-10">
                  <input type="text" id="TipoBodega" name="TipoBodega" class="form-control" placeholder="Escriba..." value="{{old('TipoBodega')}}" required>
                </div>            
              </div>            
            </div>            
          </div>            
          ...
          <div class="row ">
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                <label for="Descripcion" class="col-xs-12 col-sm-2 control-label">Descripcion</label>
                <div class="col-sm-10">
                 <!-- <input type="text" class="form-control"  > -->
                 <textarea name="Descripcion" id="Descripcion" class="form-control" rows="3" placeholder="Descripcion de la bodega..." value="{{old('Descripcion')}}" required></textarea>
               </div> 
             </div> 
           </div> 
         </div> 
