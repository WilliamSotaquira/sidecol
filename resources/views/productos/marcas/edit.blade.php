...
<section class="content">
  ...
  <div class="box box-primary">
    ...
    <div class="container">
      ...
      {!!Form::model($marcas,['method'=>'PUT','route'=>['productos.marcas.update',$marcas->idmarca],'files'=>'true'])!!}
      {{Form::token()}}
           ...
           <div class="row row-first" >
            <div class="col-xs-12 col-sm-12">
              <div class="form-group ">
                ...
                <div class="col-sm-9">
                  <input type="text" id="marca" name="marca" class="form-control" placeholder="Nombre de la marca" value="{{$marcas->marca}}" required>
                </div>            
              </div>            
            </div>            
          </div>            
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                   <input type="numbers" id="tiempogarantia" name="tiempogarantia" class="form-control" id="tiempogarantia" placeholder="Tiempo de garantia..." value="{{$marcas->tiempogarantia}}" required><span class="input-group-addon">Meses</span>
                 </div>
               </div>
             </div>
           </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-5">
          <div class="box-body">
            <div class="form-group">
              ...
              <div id="preview" class="thumbnail">
                <a href="#" id="file-select" class="btn btn-default">Elegir archivo</a>
                <img src="{{$marcas->image}}"/>                                
              </div>
              <span class="alert alert-default " id="file-info" style="margin:0px; ">Logo: {{$marcas->razonsocial}}</span>
              @endif
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="col-xs-12 col-sm-4 col-lg-2 text-center" style="padding-bottom: 5px; padding-top: 5px">
           ...
           <a href="{{route('productos.marcas.edit',$marcas->idmarca)}}" class="btn btn-default btn_end" id="back" >Limpiar</a><br>
